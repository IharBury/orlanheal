...
OrlanHeal.Monk.AvailableSpells =
{
	...
	115175, -- Soothing Mist
	{
		...
		macrotext = OrlanHeal:BuildMouseOverCastMacro(116694),
		key = 116694,
...
OrlanHeal.Monk.CooldownOptions =
{
	...
	ZenPilgrimage =
	{
		MacroText = OrlanHeal:BuildCastMacro(126892),
		SpellId = 126892,
		Update = OrlanHeal.UpdateAbilityCooldown
	},
	SurgingMist =
	{
		MacroText = OrlanHeal:BuildCastMacro(116694),
		SpellId = 116694,
		Update = OrlanHeal.UpdateAbilityCooldown
	},
	Jab =
	...
	ChiShaping =
	{
		MacroText = OrlanHeal:BuildCastMacro(175693),
		SpellId = 175693, -- Chi Shaping
		Update = OrlanHeal.UpdateAbilityCooldown
	},
	DisablingTechnique =
	{
		MacroText = OrlanHeal:BuildCastMacro(175697),
	...
	ChiExplosion =
	{
		MacroText = OrlanHeal:BuildCastMacro(157675),
